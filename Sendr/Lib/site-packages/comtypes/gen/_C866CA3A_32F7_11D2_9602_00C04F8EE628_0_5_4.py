...
__all__ = [
    'SAFT22kHz8BitMono', 'SRSActive', 'SRTAutopause',
    'SREInterference', 'DISPID_SVGetVoices', 'DISPID_SGRSRule',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechPropertyResourceUsage',
    'SP_VISEME_6', 'SpeechRuleState', 'DISPID_SPRText',
    'SpeechVoicePriority', 'SpeechSpecialTransitionType',
    'DISPID_SVAlertBoundary', 'SRTStandard', 'ISpRecoContext',
    'SSTTTextBuffer', 'SpeechGrammarTagUnlimitedDictation',
    'ISpeechRecoContext', 'SAFT24kHz8BitStereo', 'SPWF_INPUT',
    'DISPID_SRGSetWordSequenceData', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPIAudioSizeTime', 'DISPID_SLGetGenerationChange',
    'SREStateChange', '_RemotableHandle', 'SPXRO_Alternates_SML',
    'SpeechTokenKeyFiles', 'SPPHRASEREPLACEMENT', 'eLEXTYPE_PRIVATE2',
    'SAFT12kHz8BitStereo', 'SDTPronunciation', 'DISPID_SPPsItem',
    'SpAudioFormat', 'SPRST_NUM_STATES', 'DISPID_SRCreateRecoContext',
    'SITooSlow', 'DISPID_SPISaveToMemory', 'SPEI_END_INPUT_STREAM',
    'SAFT24kHz8BitMono', 'SECFDefault', 'DISPID_SDKDeleteKey',
    'SGDSActiveUserDelimited', 'IInternetSecurityManager', 'SLTApp',
    'ISpeechPhoneConverter', 'DISPID_SpeechLexicon',
    'DISPID_SVSLastResult', 'SpeechDataKeyLocation',
    'DISPID_SRRecognizer', 'ISpRecognizer3', '_ISpeechVoiceEvents',
    'SpeechCategoryAppLexicons', 'ISpDataKey', 'tagSPPROPERTYINFO',
    'DISPID_SRSCurrentStreamPosition', 'SDA_No_Trailing_Space',
    'DISPID_SPPFirstElement', 'DISPID_SGRSTNextState',
    'SRADefaultToActive', 'DISPID_SPPValue', 'DISPID_SOTsItem',
    'SpObjectTokenCategory', 'ISpObjectTokenCategory',
    'ISpeechFileStream', 'SRSActiveAlways', 'SVSFVoiceMask',
    'DISPID_SDKOpenKey', 'DISPID_SpeechAudio', 'SVPAlert',
    'SAFT22kHz16BitMono', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPDKL_DefaultLocation', 'SpeechVisemeFeature',
    'SPEI_FALSE_RECOGNITION', 'SAFT12kHz16BitMono',
    'DISPID_SOTIsUISupported', 'SpCompressedLexicon', 'SPEI_PHONEME',
    'DISPID_SRGDictationUnload', 'SPEI_SR_BOOKMARK',
    'DISPID_SDKSetStringValue', 'DISPID_SGRSTs_NewEnum',
    'ISpeechPhraseElement', 'SAFTNoAssignedFormat', 'IStream',
    'STCInprocServer', 'SINoSignal', 'DISPID_SVSVisemeId',
    'DISPID_SRGReset', 'DISPID_SpeechDataKey',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRCERecognitionForOtherContext',
    'SASRun', 'DISPID_SVSInputWordPosition', 'SPPS_RESERVED3',
    'DISPID_SDKSetBinaryValue', 'SVP_10', 'DISPID_SVEventInterests',
    'SPBO_PAUSE', 'SAFT44kHz8BitStereo', 'SP_VISEME_18',
    'SPEI_ADAPTATION', 'SAFT24kHz16BitStereo', 'DISPID_SGRsItem',
    'SP_VISEME_1', 'DISPID_SPIElements',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SP_VISEME_3', 'DISPID_SLWLangId',
    'SP_VISEME_4', 'DISPID_SLAddPronunciation', 'SPEI_SOUND_END',
    'DISPID_SRGId', 'DISPID_SPIGrammarId', 'SPEVENTSOURCEINFO',
    'DISPID_SBSWrite', 'eLEXTYPE_VENDORLEXICON', 'SPBO_TIME_UNITS',
    'SITooLoud', 'SPRST_ACTIVE', 'SRSEIsSpeaking',
    'SPPS_Interjection', 'SLOStatic', 'SpeechCategoryVoices',
    'DISPID_SLPsItem', 'DISPID_SpeechObjectTokens',
    'DISPID_SRAudioInput', 'SPSInterjection',
    'DISPID_SpeechGrammarRules', 'SpMemoryStream',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpRecoCategory',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_PRIVATE3', 'SPSNoun',
    'DISPID_SPIRule', 'SAFTText', 'DISPID_SGRSTsCount',
    'SRESoundStart', 'SPEI_MIN_SR', 'SPEI_PHRASE_START',
    'eLEXTYPE_PRIVATE10', 'SPPS_RESERVED4',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPINTERFERENCE',
    'ISpeechObjectTokens', 'SRTSMLTimeout', 'DISPID_SOTsCount',
    'SPAR_Medium', 'DISPID_SVSInputWordLength',
    'SAFT22kHz16BitStereo', 'SAFTADPCM_44kHzMono',
    'eLEXTYPE_PRIVATE17', 'DISPID_SLWWord', 'DISPID_SPIProperties',
    'SPPS_NotOverriden', 'DISPID_SPERequiredConfidence',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVGetAudioOutputs',
    'SpeechRecognitionType', 'DISPID_SASFreeBufferSpace',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechTokenIdUserLexicon', 'DISPID_SVEBookmark',
    'DISPID_SCSBaseStream', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechTokenContext', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechFormatType', 'SPPS_Modifier', 'SpCustomStream',
    'DISPID_SPRuleChildren', 'SRSInactiveWithPurge',
    'eLEXTYPE_PRIVATE9', 'SpeechCategoryRecoProfiles',
    'eLEXTYPE_PRIVATE18', 'SDA_One_Trailing_Space', 'SPAS_RUN',
    'DISPID_SVGetProfiles', 'ISpNotifySink', 'SVP_1',
    'DISPID_SDKDeleteValue', 'DISPID_SRRPhraseInfo', 'SGDSActive',
    'SAFT11kHz8BitMono', 'eLEXTYPE_PRIVATE5',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechPhraseRule', 'SPWORDPRONOUNCEABLE',
    'SPAUDIOOPTIONS', 'DISPID_SVStatus', 'DISPID_SPRuleFirstElement',
    'SREHypothesis', 'eLEXTYPE_PRIVATE19', 'SAFTGSM610_8kHzMono',
    'DISPID_SLWsItem', 'DISPID_SBSSeek', 'ISpeechObjectTokenCategory',
    'SSSPTRelativeToEnd', 'DISPID_SOTCDefault', 'SPGRAMMARWORDTYPE',
    'SWPUnknownWordPronounceable', 'SVSFUnusedFlags',
    'SPBOOKMARKOPTIONS', 'DISPID_SRIsShared', 'DISPID_SRDisplayUI',
    'SPCATEGORYTYPE', 'SPWT_DISPLAY', 'DISPID_SRCEAdaptation',
    'ISpeechVoiceStatus', 'eLEXTYPE_PRIVATE6', 'SPSEMANTICFORMAT',
    'SP_VISEME_15', 'SVPOver', 'SVF_Stressed', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCRequestedUIType', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRGRules', 'DISPID_SpeechRecoContextEvents', 'SPPHRASE',
    'SPEVENTENUM', 'SPGS_ENABLED', 'DISPID_SpeechLexiconWord',
    'SGDisplay', 'ISpeechRecoResultDispatch', 'DISPID_SGRsAdd',
    'DISPID_SPACommit', 'eLEXTYPE_RESERVED10', 'SPPS_Verb',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SWFEBlockAlign',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SOTCSetId',
    'DISPID_SVSLastBookmarkId', 'SPEI_SR_PRIVATE',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRCESoundStart', 'SRSEDone',
    'SVP_15', 'SVEViseme', 'DISPID_SGRSTPropertyId', 'SRADynamic',
    'SPWAVEFORMATTYPE', 'DISPID_SRCEInterference',
    'SPEI_SENTENCE_BOUNDARY', 'SREPropertyStringChange',
    'DISPID_SpeechLexiconProns', 'SVP_13', 'DISPID_SGRId',
    'SAFTADPCM_11kHzStereo', 'SPSHT_OTHER',
    'DISPID_SPEAudioTimeOffset', 'SPINTERFERENCE_NONE',
    'DISPID_SRCEHypothesis', 'SPEI_RESERVED1',
    'DISPID_SpeechRecoResult', 'SSFMCreate',
    'SGLexicalNoSpecialChars', 'SpTextSelectionInformation',
    'tagSTATSTG', 'SPRECOCONTEXTSTATUS', 'STSF_AppData',
    'DISPID_SVSPhonemeId', 'SPWORDPRONUNCIATIONLIST', 'ISpLexicon',
    'SPAR_Unknown', 'DISPID_SRRTTickCount',
    'DISPID_SPEAudioStreamOffset', 'ISpeechAudioBufferInfo',
    'DISPID_SOTCategory', 'SPINTERFERENCE_LATENCY_WARNING',
    'SSFMOpenForRead', 'DISPID_SMSALineId',
    'DISPID_SPRuleNumberOfElements', 'SECFEmulateResult',
    'SPRST_INACTIVE_WITH_PURGE', 'SECFIgnoreKanaType',
    'DISPID_SDKGetBinaryValue', 'SPINTERFERENCE_TOOFAST',
    'SPSHORTCUTTYPE', 'DISPID_SWFEChannels', 'ISpPhraseAlt',
    'DISPID_SVEViseme', 'SWPKnownWordPronounceable',
    'DISPID_SPIEngineId', 'DISPID_SRCERecognition', 'SRARoot',
    'DISPID_SpeechRecognizer', 'ISpeechLexiconPronunciations',
    'SVP_4', 'SpeechRegistryUserRoot', 'ISpeechLexicon',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechWordPronounceable',
    'eLEXTYPE_PRIVATE1', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCEAudioLevel', 'SpeechLexiconType',
    'DISPID_SRCEStartStream', 'SPAS_PAUSE', 'SpeechTokenShellFolder',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPPsCount',
    'ISpeechObjectToken', 'SpeechPropertyAdaptationOn',
    'SpeechCategoryAudioIn', 'SPPS_Unknown', 'DISPID_SVSkip',
    'DISPID_SPARecoResult', 'SFTInput',
    'DISPID_SVSInputSentencePosition', 'DISPID_SVIsUISupported',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPEAudioSizeTime',
    'ISpShortcut', 'ISpeechPhraseReplacements', 'STCRemoteServer',
    'DISPID_SpeechRecoContext', 'SITooFast', 'SREAllEvents',
    'DISPID_SpeechAudioBufferInfo', 'SPCS_ENABLED', 'SPLOADOPTIONS',
    'DISPID_SGRSAddWordTransition', 'DISPID_SAEventHandle',
    'SpNullPhoneConverter', 'ISpeechAudioFormat',
    'SPINTERFERENCE_NOSIGNAL', 'ISpNotifyTranslator',
    'DISPID_SVEWord', 'eLEXTYPE_PRIVATE8', 'SPRS_INACTIVE',
    'SAFT44kHz8BitMono', 'ISpeechBaseStream', 'SPVISEMES',
    'DISPID_SVEStreamEnd', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechAudioFormat', 'SAFTADPCM_11kHzMono',
    'DISPID_SRCEventInterests', 'SGSExclusive',
    'DISPID_SRRGetXMLErrorInfo', 'SpInProcRecoContext', 'SBONone',
    'SPEI_VOICE_CHANGE', 'DISPID_SPCPhoneToId',
    'DISPID_SPIReplacements', 'SINoise', 'DISPID_SpeechVoiceStatus',
    'Speech_Default_Weight', 'SPSMF_UPS', 'DISPID_SLPsCount',
    'SAFT12kHz8BitMono', 'DISPID_SAStatus', 'SpeechGrammarWordType',
    'DISPID_SOTCreateInstance', 'SP_VISEME_10',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechMicTraining',
    'SpWaveFormatEx', 'SAFTADPCM_8kHzStereo', 'DISPID_SLPSymbolic',
    'DISPID_SRRTOffsetFromStart', 'SPVOICESTATUS',
    'ISpeechPhraseReplacement', 'DISPID_SPRulesCount',
    'DISPID_SVSyncronousSpeakTimeout', 'SASPause',
    'SREPropertyNumChange', 'SAFT24kHz16BitMono',
    'DISPID_SpeechPhraseReplacements', 'SVP_8', 'SDTRule',
    'DISPID_SOTCGetDataKey', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SVVoice',
    'DISPID_SVPriority', 'SGRSTTWildcard', 'DISPID_SPRulesItem',
    'SpeechStreamSeekPositionType', 'ISpeechAudioStatus',
    'SDTDisplayText', 'eWORDTYPE_ADDED', 'DISPID_SOTCEnumerateTokens',
    'SpMMAudioEnum', 'DISPID_SPELexicalForm', 'ISpMMSysAudio',
    'SPCT_SUB_COMMAND', 'DISPID_SRCVoicePurgeEvent', 'ISpeechAudio',
    'SPPS_Noncontent', 'eLEXTYPE_PRIVATE4',
    'SpPhoneticAlphabetConverter', 'ISpeechCustomStream',
    'DISPID_SPRuleParent', 'SPSHT_Unknown', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRsFindRule', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPPParent', 'DISPID_SVAudioOutputStream',
    'DISPID_SGRSTRule', 'DISPID_SWFEBitsPerSample',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRCEPropertyNumberChange',
    'SPPS_RESERVED2', 'DISPID_SRCESoundEnd', 'SVSFNLPMask',
    'SPEI_RECO_STATE_CHANGE', 'SVSFParseSapi', 'SpeechVoiceEvents',
    'DISPID_SGRsCount', 'SPSSuppressWord', 'DISPID_SPRuleName',
    'ISpProperties', 'eLEXTYPE_RESERVED7',
    'SpeechVoiceCategoryTTSRate', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_MORPHOLOGY',
    'SPLO_STATIC', 'SAFTADPCM_44kHzStereo', 'SPSNotOverriden',
    'SPEI_UNDEFINED', 'SPAR_High', 'DISPID_SPAStartElementInResult',
    'SPEI_TTS_BOOKMARK', 'SPAUDIOSTATE', 'SRTEmulated',
    'SAFT32kHz8BitStereo', 'DISPID_SPCLangId', 'ISpSerializeState',
    'DISPID_SpeechVoice', 'SpeechPropertyLowConfidenceThreshold',
    'eLEXTYPE_PRIVATE20', 'SASStop', 'DISPID_SPERetainedSizeBytes',
    'SVP_14', 'SAFT11kHz8BitStereo', 'SpeechUserTraining',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SLWs_NewEnum',
    'SPCT_SLEEP', 'SAFTCCITT_uLaw_8kHzStereo', 'SPINTERFERENCE_NOISE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPPS_SuppressWord',
    'SPEI_INTERFERENCE', 'SpMMAudioIn', 'SLTUser',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechPhraseElement', 'DISPID_SPAsCount',
    'ISpeechTextSelectionInformation', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechRecognizerStatus', 'SGRSTTWord', 'SAFT8kHz8BitMono',
    'DISPID_SLWsCount', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_PRIVATE14', 'DISPID_SLWType', 'SPCT_SUB_DICTATION',
    'SpeechTokenKeyAttributes', 'SWTAdded', 'DISPID_SMSGetData',
    'SpeechEngineConfidence', 'SAFTCCITT_uLaw_22kHzMono',
    'SVSFParseSsml', 'DISPID_SVPause', 'SVPNormal',
    'SAFT8kHz8BitStereo', 'ISpeechRecoResultTimes', 'DISPID_SPEsItem',
    'SPSFunction', 'SSFMOpenReadWrite', 'IInternetSecurityMgrSite',
    'SpeechPropertyResponseSpeed', 'DISPID_SFSClose',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPPBRestorePhraseFromMemory', 'STCInprocHandler',
    'DISPID_SABIBufferSize', 'SpeechDiscardType',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPRNumberOfElements',
    'DISPID_SRSNumberOfActiveRules', 'SDTAlternates',
    'SAFTCCITT_uLaw_11kHzMono', 'SVP_3', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRGCommit', 'DISPID_SPEAudioSizeBytes', 'DISPID_SPRsItem',
    'DISPID_SVAudioOutput', 'SGRSTTTextBuffer', 'STCAll',
    'SDTReplacement', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPEsCount',
    'SpeechRecoContextState', 'SPPHRASEPROPERTY',
    'DISPID_SPCIdToPhone', 'SAFT32kHz8BitMono', 'SPSERIALIZEDPHRASE',
    'SPRULE', 'DISPID_SPRDisplayAttributes', 'SpeechRuleAttributes',
    'WAVEFORMATEX', 'SVP_6', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_12',
    'DISPID_SLGetPronunciations', 'DISPID_SPRuleId',
    'DISPID_SpeechGrammarRuleState', 'SPCONTEXTSTATE',
    'ISpeechPhraseAlternate', 'SVEWordBoundary',
    'ISpPhoneticAlphabetConverter', 'ISpPhoneConverter',
    'DISPID_SRCPause', 'SPFM_OPEN_READONLY', 'SPWORDPRONUNCIATION',
    'SVP_7', 'ISpObjectWithToken', 'SREStreamEnd', 'DISPID_SVVolume',
    'DISPID_SDKSetLongValue', 'SP_VISEME_16', 'SRCS_Disabled',
    'SAFT11kHz16BitMono', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRSClsidEngine', 'DISPID_SpeechAudioStatus',
    'SSTTWildcard', 'DISPID_SGRSTsItem', 'DISPID_SABIMinNotification',
    'SREAdaptation', 'DISPID_SRAudioInputStream',
    'DISPID_SRCERequestUI', 'DISPID_SASetState', 'SpeechWordType',
    'DISPID_SRRSpeakAudio', 'SPSERIALIZEDRESULT',
    'DISPID_SOTs_NewEnum', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SOTRemove', 'DISPID_SRGCmdSetRuleState',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechResourceLoader',
    'SGRSTTDictation', 'SAFTCCITT_uLaw_8kHzMono',
    'SECNormalConfidence', 'DISPID_SRCVoice', 'SPBO_AHEAD', 'SpVoice',
    'SPSEMANTICERRORINFO', 'DISPID_SRCSetAdaptationData',
    'DISPID_SPPEngineConfidence', '_ISpeechRecoContextEvents',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SGRSTType',
    'SpeechRecoProfileProperties', 'DISPID_SpeechXMLRecoResult',
    'SPWT_LEXICAL', 'DISPID_SRGetPropertyString',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpStream', 'SVP_19',
    'DISPID_SVESentenceBoundary', 'DISPID_SRSSupportedLanguages',
    'SRSInactive', 'DISPID_SABufferInfo',
    'DISPID_SRCEFalseRecognition', 'SPEI_RESERVED6', 'SPXRO_SML',
    'DISPID_SPEEngineConfidence', 'SPVPRI_OVER', 'SPWORDLIST',
    'SPFM_OPEN_READWRITE', 'SpeechEmulationCompareFlags',
    'SAFT44kHz16BitMono', 'eLEXTYPE_PRIVATE11', 'ISpeechGrammarRule',
    'DISPID_SGRSTWeight', 'SpeechCategoryPhoneConverters',
    'SPEI_HYPOTHESIS', 'SAFT48kHz8BitMono', 'SRAInterpreter',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRCCreateGrammar', 'SAFTCCITT_ALaw_22kHzMono',
    'SVEAudioLevel', 'SPEI_RECOGNITION', 'DISPID_SPIAudioSizeBytes',
    'SVP_11', 'SPSModifier', 'SPVPRI_NORMAL', 'STSF_LocalAppData',
    'DISPID_SPPNumberOfElements', 'SVSFParseMask', 'SDTAll',
    'SPAO_NONE', 'SPEI_MAX_TTS', 'SPPS_Noun', 'DISPID_SRRTLength',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPRFirstElement',
    'SPSHORTCUTPAIR', 'DISPID_SAFGuid', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_USER', 'SVP_0', 'eWORDTYPE_DELETED', 'SREPrivate',
    'SPAR_Low', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVGetAudioInputs', 'ISpObjectToken',
    'DISPID_SVSpeakCompleteEvent', 'SRERequestUI',
    'DISPID_SVEPhoneme', 'SSTTDictation', 'ISpAudio',
    'SAFT8kHz16BitStereo', 'SPVPRIORITY', 'DISPID_SVWaitUntilDone',
    'SpObjectToken', 'DISPIDSPRG', 'SpeechStreamFileMode',
    'SPAS_CLOSED', 'DISPID_SGRAddResource', 'SSFMCreateForWrite',
    'SRESoundEnd', 'DISPID_SPIRetainedSizeBytes', 'SGRSTTRule',
    'DISPID_SABufferNotifySize', 'DISPID_SGRSTransitions',
    'DISPID_SLGetWords', 'SPSLMA', 'ISpeechPhraseRules',
    'DISPID_SPAsItem', 'ISpeechRecognizer', 'SPDKL_CurrentConfig',
    'ISpRecognizer2', 'DISPID_SWFEFormatTag', 'SPEI_RESERVED3',
    'SpMMAudioOut', 'SP_VISEME_17', 'DISPID_SpeechGrammarRule',
    'DISPID_SRRSaveToMemory', 'DISPID_SGRInitialState',
    'DISPID_SpeechLexiconPronunciation', 'SDKLLocalMachine',
    'SVSFlagsAsync', 'Speech_Max_Word_Length',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVDisplayUI',
    'SPPS_RESERVED1', 'DISPID_SPIGetText', 'SPLO_DYNAMIC',
    'ISpXMLRecoResult', 'SVSFDefault', 'ISpeechRecoResult2',
    'SPFM_NUM_MODES', 'SPPARTOFSPEECH', 'DISPID_SREmulateRecognition',
    'SPEI_END_SR_STREAM', 'SP_VISEME_21', 'SpResourceManager',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechDataKey', 'SPGRAMMARSTATE',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRRAlternates',
    'SASClosed', 'SPPS_LMA', 'SVSFNLPSpeakPunc', 'SPEI_VISEME',
    'DISPID_SASNonBlockingIO', 'SpeechRunState',
    'DISPID_SpeechLexiconWords', 'DISPID_SPPs_NewEnum',
    'DISPID_SPRules_NewEnum', 'DISPID_SBSRead', 'SVP_21',
    'SP_VISEME_7', 'DISPID_SDKGetStringValue', 'SVSFIsFilename',
    'DISPID_SMSADeviceId', 'ISpeechLexiconPronunciation',
    'SpeechLoadOption', 'SPRECORESULTTIMES', 'DISPID_SVSpeakStream',
    'DISPID_SRGRecoContext', 'DISPID_SOTId', 'SDTProperty',
    'SpStreamFormatConverter', 'DISPID_SRState', 'SVSFIsNotXML',
    'DISPID_SVSpeak', 'SPWORDTYPE', 'SECFIgnoreCase',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPIAudioStreamPosition',
    'SVF_None', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRClear',
    'DISPID_SPIEnginePrivateData', 'SREBookmark',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCEEndStream', 'DISPID_SDKEnumValues', 'SITooQuiet',
    'SPXMLRESULTOPTIONS', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRRGetXMLResult', 'ISpPhoneticAlphabetSelection',
    'DISPID_SDKCreateKey', 'SGDSActiveWithAutoPause',
    'SpeechTokenKeyUI', 'STSF_FlagCreate', 'SPEVENT', 'SRTReSent',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechCustomStream',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGIsPronounceable', 'ISequentialStream',
    'DISPID_SLPPhoneIds', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPPConfidence', 'SPPROPERTYINFO', 'SPDKL_CurrentUser',
    'SAFTNonStandardFormat', 'SPPHRASEELEMENT',
    'DISPID_SDKGetlongValue', 'SpSharedRecoContext',
    'SpSharedRecognizer', 'SpPhoneConverter', 'SLODynamic',
    'DISPID_SpeechFileStream', 'DISPID_SRCERecognizerStateChange',
    'ISpRecoContext2', 'DISPID_SpeechRecoResult2',
    'ISpeechMemoryStream', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechCategoryAudioOut', 'SAFT16kHz8BitStereo',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechPropertyHighConfidenceThreshold',
    'ISpPhrase', 'SAFTExtendedAudioFormat', 'SPCT_DICTATION',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPGS_DISABLED', 'SP_VISEME_2',
    'SPINTERFERENCE_TOOQUIET', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPEDisplayText',
    'SP_VISEME_13', 'DISPID_SRCRetainedAudio', 'SpeechAddRemoveWord',
    'DISPID_SPAPhraseInfo', 'SVP_5', 'SP_VISEME_0', 'SREStreamStart',
    'SPRULESTATE', 'ISpResourceManager', 'SPSVerb',
    'DISPID_SOTGetDescription', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SpeechPhraseInfo', 'SGPronounciation', 'SECLowConfidence',
    'DISPID_SMSSetData', '__MIDL_IWinTypes_0009',
    'SVSFParseAutodetect', 'SPRECOSTATE', 'DISPID_SVResume',
    'SP_VISEME_19', 'SPEI_MAX_SR', 'SAFT48kHz16BitStereo',
    'SAFTADPCM_8kHzMono', 'ISpeechPhraseAlternates',
    'DISPID_SVEEnginePrivate', 'SGRSTTEpsilon', 'DISPID_SPRsCount',
    'ISpeechPhraseInfo', 'ISpRecoGrammar2', 'SPWT_PRONUNCIATION',
    'IEnumSpObjectTokens', 'SAFT44kHz16BitStereo',
    'DISPID_SPAs_NewEnum', 'SVEAllEvents', 'SAFTADPCM_22kHzMono',
    'DISPID_SFSOpen', 'SVEVoiceChange', 'SPSUnknown',
    'SPAUDIOBUFFERINFO', 'DISPID_SRRAudioFormat', 'SPRST_INACTIVE',
    'SPDATAKEYLOCATION', 'SVSFPurgeBeforeSpeak',
    'SPTEXTSELECTIONINFO', 'ISpEventSource',
    'SAFTCCITT_uLaw_11kHzStereo', 'SFTSREngine', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRCResume', 'SVEBookmark', 'SAFTGSM610_22kHzMono',
    'Speech_Max_Pron_Length', 'DISPID_SpeechVoiceEvent',
    'eLEXTYPE_APP', 'eLEXTYPE_RESERVED9', 'DISPID_SLWPronunciations',
    'ISpRecognizer', 'ISpeechMMSysAudio', 'DISPID_SABIEventBias',
    'SpeechAudioVolume', 'DISPID_SRStatus', 'SpFileStream',
    'DISPID_SRRTimes', 'SPADAPTATIONRELEVANCE', 'DISPID_SPIStartTime',
    'DISPID_SPPId', 'ISpeechPhraseElements', 'SP_VISEME_8',
    'DISPID_SpeechPhraseRules', 'SPWORD',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SADefaultFormat', 'SAFTGSM610_44kHzMono',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SGRSTPropertyName',
    'DISPID_SGRSAddSpecialTransition', 'SRERecognition',
    'ISpeechPhraseRule', 'DISPID_SRCEEnginePrivate', 'SRAImport',
    'SP_VISEME_12', 'DISPID_SLRemovePronunciation', 'ISpRecoResult',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVEStreamStart',
    'DISPID_SRRSetTextFeedback', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCRetainedAudioFormat', 'SAFT16kHz16BitStereo',
    'DISPID_SPEPronunciation', 'DISPID_SOTCId',
    'SPEI_START_SR_STREAM', 'SpeechPartOfSpeech', 'SpeechAudioState',
    'SRTExtendableParse', 'ISpeechGrammarRules',
    'DISPID_SPEDisplayAttributes', 'SPEI_SR_RETAINEDAUDIO',
    'SP_VISEME_5', 'SAFT32kHz16BitMono',
    'SWPUnknownWordUnpronounceable', 'SDKLDefaultLocation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechAllElements',
    'SAFT16kHz8BitMono', 'DISPID_SRCState', 'SVF_Emphasis',
    'SPBO_NONE', 'DISPID_SPEs_NewEnum', 'SPCS_DISABLED',
    'DISPID_SGRAttributes', 'SPEI_MIN_TTS', 'ISpStreamFormat',
    'SpeechTokenValueCLSID', 'SRAONone', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_RECO_OTHER_CONTEXT', 'SpInprocRecognizer',
    'SVEEndInputStream', 'SPPS_Function', 'IEnumString',
    'SPSHORTCUTPAIRLIST', 'ISpeechPhraseProperties',
    'SVESentenceBoundary', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechPhraseInfoBuilder', 'SGLexical',
    'DISPID_SRSetPropertyString', 'SpeechEngineProperties',
    'DISPID_SAVolume', 'DISPID_SRProfile', 'SSSPTRelativeToStart',
    'DISPID_SOTGetStorageFileName', 'ISpeechRecoResult',
    'SpeechRecoEvents', 'ISpVoice', 'SWTDeleted',
    'ISpeechGrammarRuleState', 'SpeechBookmarkOptions',
    'SECFNoSpecialChars', 'DISPID_SRGState',
    'DISPID_SRGCmdSetRuleIdState', 'SREAudioLevel',
    'DISPID_SGRsCommit', 'SPEI_RESERVED5', 'SP_VISEME_20',
    'ISpeechXMLRecoResult', 'SPAO_RETAIN_AUDIO',
    'SAFT12kHz16BitStereo', 'DISPID_SWFESamplesPerSec', 'SPFM_CREATE',
    'DISPID_SAFSetWaveFormatEx', 'SPCT_COMMAND', 'SP_VISEME_14',
    'DISPID_SRIsUISupported', 'SVEPhoneme', 'SDTLexicalForm',
    'DISPID_SRGetRecognizers', 'SAFT48kHz16BitMono',
    'SpeechAudioFormatGUIDText', 'SPRS_ACTIVE',
    'SAFTADPCM_22kHzStereo', 'SGSDisabled', 'Speech_StreamPos_Asap',
    'SpeechGrammarTagDictation', 'DISPIDSPTSI',
    'DISPID_SPRuleConfidence', 'SAFT48kHz8BitStereo',
    'DISPID_SLPType', 'SRAORetainAudio', 'SVP_9', 'SPGS_EXCLUSIVE',
    'SpeechVisemeType', 'ISpStreamFormatConverter',
    'SAFT16kHz16BitMono', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRRRecoContext', 'SpeechAudioFormatType',
    'SpPhraseInfoBuilder', 'DISPID_SPERetainedStreamOffset',
    'SAFTDefault', 'eLEXTYPE_PRIVATE7', 'DISPID_SPPChildren',
    'ISpEventSink', 'SPSTREAMFORMATTYPE',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRRAudio',
    'ISpeechWaveFormatEx', 'DISPID_SOTSetId', 'DISPID_SRSAudioStatus',
    'DISPID_SGRSAddRuleTransition', 'SVSFIsXML',
    'DISPID_SVEVoiceChange', 'DISPID_SASState',
    'SpeechGrammarTagWildcard', 'SPAUDIOSTATUS', 'SpeechGrammarState',
    'SRATopLevel', 'DISPID_SOTDisplayUI', 'SREPhraseStart',
    'ISpeechPhraseProperty', 'SpeechVoiceSpeakFlags', 'SRCS_Enabled',
    'SpeechRecognizerState', 'SPEI_RESERVED2',
    'DISPID_SVSLastStreamNumberQueued', 'ISpeechRecoGrammar',
    'DISPID_SpeechPhraseBuilder', 'ISpStream',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechLexiconWords',
    'SpNotifyTranslator', 'UINT_PTR', 'DISPID_SGRsDynamic',
    'SPLEXICONTYPE', 'SVP_18', 'DISPID_SRSetPropertyNumber',
    'SpShortcut', 'DISPID_SpeechRecoResultTimes', 'SINone',
    'SDA_Consume_Leading_Spaces', 'SpLexicon', 'DISPID_SRGetFormat',
    'DISPID_SWFEExtraData', 'SBOPause', 'SVP_16', 'SPPHRASERULE',
    'STSF_CommonAppData', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SpeechObjectToken', 'DISPID_SMSAMMHandle',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechBaseStream',
    'SAFTGSM610_11kHzMono', 'SPFILEMODE', 'SPEI_REQUEST_UI',
    'SPEI_WORD_BOUNDARY', 'SPVPRI_ALERT',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_11',
    'DISPID_SGRs_NewEnum', 'ISpNotifySource', 'SGDSInactive',
    'eLEXTYPE_RESERVED4', 'DISPID_SPPName', '_SPAUDIOSTATE',
    'SpeechDictationTopicSpelling', 'SDTAudio', 'SVP_2',
    'DISPID_SVRate', 'SpeechPropertyComplexResponseSpeed',
    'SDKLCurrentConfig', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SDKEnumKeys', 'DISPID_SVEAudioLevel',
    'DISPID_SRRTStreamTime', 'LONG_PTR', 'SPEI_SOUND_START',
    'DISPID_SRCEPhraseStart', 'SPSHT_NotOverriden', 'ISpeechVoice',
    'DISPID_SGRName', 'SPDKL_LocalMachine',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechPhraseElements',
    'DISPID_SLPs_NewEnum', 'SRERecoOtherContext',
    'DISPID_SRGSetTextSelection', 'SECHighConfidence',
    'DISPID_SOTDataKey', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT8kHz16BitMono', 'SVEStartInputStream',
    'DISPID_SRGDictationSetState', 'DISPID_SGRSTText', 'SPSHT_EMAIL',
    'DISPID_SGRAddState', 'SPAS_STOP', 'DISPID_SOTGetAttribute',
    'SVP_17', 'SPWF_SRENGINE', 'SAFT11kHz16BitStereo',
    'SAFT32kHz16BitStereo', 'SVEPrivate',
    'DISPID_SPEActualConfidence', 'SAFTCCITT_uLaw_44kHzStereo',
    'SDKLCurrentUser', 'DISPID_SVSRunningState', 'SECFIgnoreWidth',
    'DISPID_SBSFormat', 'DISPID_SpeechPhraseProperties',
    'SPFM_CREATE_ALWAYS', 'SVSFPersistXML', 'SpeechAudioProperties',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRGDictationLoad', 'DISPID_SVSLastBookmark',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_RESERVED8',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechPhoneConverter', 'SpeechRetainedAudioOptions',
    'SPBINARYGRAMMAR', 'DISPID_SAFType', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_RESERVED6', 'SP_VISEME_9', 'SpeechInterference',
    'DISPID_SRCBookmark', 'SpUnCompressedLexicon',
    'DISPID_SPILanguageId', 'STCLocalServer', 'DISPID_SRCEBookmark',
    'DISPID_SLGenerationId', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRCRecognizer', 'SPSMF_SAPI_PROPERTIES', 'SGSEnabled',
    'SpeechVoiceSkipTypeSentence', 'SVP_20', 'SREFalseRecognition',
    'SpeechDisplayAttributes', 'SPRECOGNIZERSTATUS',
    'ISpeechLexiconWord', 'SpeechCategoryRecognizers',
    'ISpGrammarBuilder', 'DISPID_SLPLangId',
    'Speech_StreamPos_RealTime', 'ISpRecoGrammar', 'SRAExport'
]

_check_version('1.2.0', 1698507948.037653)
